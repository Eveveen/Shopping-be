       ...
       <div class="ui small message" id="showApiKey">
           <div class="ui form segment">
                <div class="inline field">
                   ...
                   <a class="ui mini green button"  href="javascript:" id="activeBtn"></a>
        				
        				<!-- <a class="ui mini green button"  href="javascript:void(0)" id="copyApiKey">复制</a> -->
			...
			<c:forEach items="${deviceList }" var="device">
				<div class="column">
					<div class="ui blue segment">
						<a href="manageDevice/${device.deviceId }" class="content">
							...
							<p class="sensorStatus">传感器状态：
								<c:forEach items="${device.sensors }" var="sensors">
                               		<span class="ui ${sensors.status == 1 ? "green ok" : "red error" } label" data-variation="inverted"></span>
                               	</c:forEach>
	                        </p>
						</a>
					</div>
...
<script>
	$(document).ready(function(){
		...
		$("#activeBtn").click(function(){
			...
			if($(this).html() == "激活"){				
				window.location.href="apikeyTologin/" + apiKey;
			} else {
				copyApiKey();
			}
			
			 /* $.ajax({
				url:"apikeyTologin/" + apiKey,
				data:{},
				dataType:"text",
				type:"POST",
